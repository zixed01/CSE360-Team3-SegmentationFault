...
namespace PulseTesting {
	...
	/// <summary>
	/// Summary for AdminAddUserView
	/// </summary>
	public ref class AdminAddUserView : public System::Windows::Forms::Form
	{
	public:
		AdminAddUserView(SessionData ^ s, String ^ username, String ^ password)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Name = L"AdminAddUserView";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"AdminAddUserView";
