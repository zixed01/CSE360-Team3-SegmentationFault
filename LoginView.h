...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->forgotPW_lbl->Click += gcnew System::EventHandler(this, &LoginView::forgotPW_lbl_Click);
			// 
			// login_message
			// 
...
private: System::Void login_btn_Click(System::Object^  sender, System::EventArgs^  e) {
			...
			//if login is true -> send to main screen of specific user type
...
private: System::Void forgotPW_lbl_Click(System::Object^  sender, System::EventArgs^  e) {
			...
			cout<<"Reset Password: Complete"<<endl;
			cout<<"Contact System Administrator for new password"<<endl;
		 }
};
}
